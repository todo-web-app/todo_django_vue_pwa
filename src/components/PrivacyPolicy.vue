<template>
  <div>
    ...
    Family List operates https://todo-django-vue-pwa.herokuapp.com/. 
    ...
    This Privacy Policy is effective as of 04-29-2020 and will remain in effect except with respect to any
